...
function whichPlayer() {
    if (currentPlayer === 'cross') {
        document.getElementById("circle").style.stroke = "#026c92";
        document.getElementById("cross1").style.stroke = "#FFC000";
        document.getElementById("cross2").style.stroke = "#FFC000";
    } else {
        document.getElementById("circle").style.stroke = "#00B0EF";
        document.getElementById("cross1").style.stroke = "#7f6001";
        document.getElementById("cross2").style.stroke = "#7f6001";
    }
}
